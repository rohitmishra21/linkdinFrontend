    ...
    return (
        <div className='flex flex-col items-center gap-5 justify-center h-screen'>
            <label className="input validator">
                ...
                <input value={firstName} onChange={(e) => setfirstName(e.target.value)} type="input" required placeholder="FirstName" pattern="[A-Za-z][A-Za-z0-9\-]*" minlength="3" maxlength="30" title="Only letters, numbers or dash" />
            </label>
            <label className="input validator">
                <svg className="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" fill="none" stroke="currentColor"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></g></svg>
                <input value={lastName} onChange={(e) => setLasttName(e.target.value)} type="input" required placeholder="LastName" pattern="[A-Za-z][A-Za-z0-9\-]*" minlength="3" maxlength="30" title="Only letters, numbers or dash" />
            </label>
            <label className="input validator">
