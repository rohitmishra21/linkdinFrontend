...
const HomeNavBar = () => {
    return (
        <div className='flex justify-between items-center'>
            <div className='w-32'>
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 84 21" preserveAspectRatio="xMinYMin meet" version="1.1" focusable="false" className="lazy-loaded" aria-busy="false">
            ...
            <div className='flex items-center gap-8'>
                <Link to="/signUp" className='text-lg font-medium cursor-pointer'>Join now</Link>
                <Link to="/signin" className="btn rounded-full btn-outline btn-info">Sign in</Link>
            </div>
        </div>
    )
}
